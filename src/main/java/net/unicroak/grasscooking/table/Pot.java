...
public class Pot extends Cooker {
    ...
    static {
        PADDING_ICON_FENCE = initIcon(Material.IRON_FENCE, 0, null, null);
        PADDING_ICON_FIRE = initIcon(Material.STAINED_GLASS_PANE, 14, null, null);
        MAKING_ICON = initIcon(Material.CAULDRON_ITEM, 0, ChatColor.RED + "調理する", null);
    }
